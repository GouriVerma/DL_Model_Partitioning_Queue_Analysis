...
import logging
logging.basicConfig(filename='simulator_multi_source_multi_devices.log', level=logging.DEBUG, filemode='w')
...
class Simulator:
    ...
    def __init__(self, numLayers, layersFlops, layersActivationSize, gridSize, deviceToPartitionMapping, deviceComputeCapacity, linksBandwidth, env, partition: Optional[Union[Dict[int, List[int]], List[List[int]]]]=None, arrival_rate=1, default_bw=1, sim_duration=50, sampling_interval=1, task_generating_device_ids=None, input_task_size=32, global_poisson_stream=False, random_seed: Optional[int]=None, next_device_assignment_policy="random", next_device_random_seed: Optional[int]=None):
...
if __name__ == "__main__":
    ...
    device_to_partition = {0: 0, 1: 1, 2: 0}  # device_id: partition_idx
    ...
    sim = Simulator(
        ...
        sim_duration            = 1000,
        sampling_interval       = 1,
        task_generating_device_ids = [0, 3],
        input_task_size         = 5,
